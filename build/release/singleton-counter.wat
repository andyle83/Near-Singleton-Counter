(module
 ...
 (memory $0 1)
 (data (i32.const 1036) ",")
 (data (i32.const 1048) "\01\00\00\00\14\00\00\00h\00e\00l\00l\00o\00 \00n\00e\00a\00r")
 (data (i32.const 1084) "<")
 ...
 (export "hello_near" (func $assembly/index/__wrapper_hello_near))
 ...
 (func $assembly/index/__wrapper_hello_near
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
